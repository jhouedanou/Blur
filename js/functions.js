...
Cufon.replace('div.panel-wrapper p');
  $('div.panel-wrapper p').css({display: 'block'}).show();
...
Cufon.replace('.title',{
  ...
  $('.title').css({display: 'block'}).show();

	     Cufon.replace('#nom',{
          fontWeight: 'bold',
          textShadow: '0 0 10px #514E45'
});
       $('#nom').css({display: 'block'}).show();
